...
export default function Aurora(props) {
  ...
  useEffect(() => {
    ...
    const update = t => {
      ...
      program.uniforms.uAmplitude.value = (propsRef.current && propsRef.current.amplitude) ?? amplitude;
      program.uniforms.uBlend.value = (propsRef.current && propsRef.current.blend) ?? blend;
      const stops = (propsRef.current && propsRef.current.colorStops) || colorStops;
